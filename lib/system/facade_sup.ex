defmodule Extreme.System.FacadeSup do
  ...
  def start_link(facade_module, facade_name, opts \\ []),
    do:
      Supervisor.start_link(__MODULE__, {facade_module, facade_name, opts},
        name: name(facade_name)
      )
  ...
  def init({facade_module, facade_name, opts}) do
    children = [
      ...
      worker(facade_module, [
        request_sup_name(facade_name),
        cache_name(facade_name),
        Keyword.put(opts, :name, facade_name)
      ])
    ]
