defmodule Extreme.System.RabbitMQ.Consumers do
  ...
  defp define_worker(channel_manager, {:publisher, name, targets}),
    do:
      worker(Extreme.System.RabbitMQ.Publisher, [channel_manager, name, targets, [name: name]],
        id: name
      )

  defp define_worker(channel_manager, {:listener, name, definition}),
    do:
      worker(Extreme.System.RabbitMQ.Listener, [channel_manager, name, definition, [name: name]],
        id: name
      )
end
